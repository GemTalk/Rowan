...
createOn: aUrl alias: aString
	...
	^self createOn: aUrl alias: aString withGemStoneFileouts: false
%
...
set compile_env: 0
method: CypressFileSystemRepository
gemStoneFileoutsEnabled: aBoolean

	self gemStoneFileoutsProperty: aBoolean printString
...
set compile_env: 0
method: CypressPackageManager2
writePackageFor: aPackageInformation toRepository: aRepository

	aPackageInformation writePackageToRepository: aRepository.
%
...
set compile_env: 0
method: CypressKnownPackageInformation
writePackageToRepository: aRepository

	self writePackageToRepositories: (Array with: aRepository).
%
